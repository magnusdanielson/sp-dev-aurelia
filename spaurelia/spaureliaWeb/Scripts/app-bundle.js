...
define('main',["require", "exports", './environment', 'jquery', 'bootstrap'], function (require, exports, environment_1) {
    ...
    function configure(aurelia) {
        ...
        aurelia.start().then(function () { return aurelia.setRoot('todos'); });
    }
...
define('sp-title',["require", "exports", 'aurelia-framework', 'aurelia-fetch-client'], function (require, exports, aurelia_framework_1, aurelia_fetch_client_1) {
    "use strict";
    var Users = (function () {
        function Users(http) {
            this.http = http;
        ...
        Users.prototype.activate = function () {
            ...
            return this.http.fetch('api/sp/1')
                ...
                .then(function (webTitle) { return _this.webTitle = webTitle; });
        };
        Users.prototype.addAurelia = function () {
        ...
        Users.prototype.removeAurelia = function () {
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"bootstrap/css/bootstrap.css\"></require>\r\n    <require from=\"./styles/styles.css\"></require>\r\n    <require from=\"./nav-bar.html\"></require>\r\n  \r\n<nav-bar router.bind=\"currentRouter\"></nav-bar>\r\n<div class=\"page-host\">\r\n  <router-view></router-view>\r\n</div>\r\n</template>"; });
